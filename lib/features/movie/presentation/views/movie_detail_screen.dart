...
import 'package:clean_arch_movie_app/features/movie/presentation/views/dummy.dart';
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8.0),
                          Text(
                            'Genres: ${state.movieDetails!.genres.map((genre) => genre.name).join(', ')}',
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 12.0,
                              fontWeight: FontWeight.w500,
